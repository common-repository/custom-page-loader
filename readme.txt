...
Add a custom page loader to your website

== Description ==
Choose whether you want to display the logo, site title, custom image or custom text and easily style colours using the WordPress customiser controls
...
== Screenshots ==
1. Logo customiser view
1. Site Title customiser view
1. Custom Image  customiser view
1. Custom Text customiser view

== Changelog ==
=0.2=
Updated to hide unneeded controls in the customiser
